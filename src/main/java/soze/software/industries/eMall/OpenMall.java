...
public class OpenMall {
    ...
    public static void main(String[] args) {
        ...
        MonetaryValue flatPriceDistortion = new MonetaryValue(new RealNumber(-100), RON);
        ...
        flatPriceDistortion = new MonetaryValue(new RealNumber(-400), RON);
        ProductGroup compProductGroup = new ProductGroup(user, "Computers", flatPriceDistortion, new RealNumber(-1.5));
        compProductGroup.addChildProductGroup(productGroup);
